...
3. In the block inspector panel, select the campaign you want to embed from the **Campaign** dropdown.
4. The wrapper block can contain any combination of the built-in inner blocks:
...
> **Tip:** The Campaign Wrapper block is designed for use on the single-campaign post template generated by the plugin, but it can also be added to any post or page to embed a specific campaign.
