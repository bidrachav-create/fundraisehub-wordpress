...
if ( $api_url && $campaign_id ) {
	...
	echo '<strong>' . esc_html__( 'FundRaiseHub – Donation Tiles: embed unavailable', 'fundraisehub-core' ) . '</strong> ' . $frhub_missing; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already escaped
	echo '</div>';
}
