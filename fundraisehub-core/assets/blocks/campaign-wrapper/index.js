( () => {
	...
	const n = window.wp.blocks,
		a = JSON.parse( '{"UU":"fundraisehub/campaign-wrapper"}' ),
		i = window.wp.i18n,
	...
	( 0, n.registerBlockType )( a.UU, {
		edit() {
			const n = ( 0, e.useBlockProps )( {
				className: 'fundraisehub-campaign-wrapper',
			} );
			return window.fundraisehubData?.apiKeyConfigured
				? ( 0, u.jsx )( 'div', {
						...n,
						children: ( 0, u.jsx )( e.InnerBlocks, {
							allowedBlocks: r,
						} ),
				  } )
				: ( 0, u.jsx )( 'div', {
						...n,
						children: ( 0, u.jsx )( s.Placeholder, {
							icon: 'lock',
							label: ( 0, i.__ )(
								'FundRaiseHub Campaign',
								'fundraisehub-core'
							),
							instructions: ( 0, i.__ )(
