<?php
/**
 * Elementor widget: Campaign Description.
 *
 ...
 *
 * Renders the campaign description text via Elementor.
 */
class CampaignDescription extends CampaignWidgetBase {

	/**
	 * Return the unique widget name.
	 */
	public function get_name(): string {
		return 'fundraisehub-campaign-description';
	}
	...
	public function get_title(): string {
		return esc_html__( 'Campaign Description', 'fundraisehub-elementor' );
	}
